	...
	local Library do
		...
		local Components = { } do
			...
			Components.Checkbox = function(Data)
				...
				Items["Checkbox"]:Connect("InputBegan", function(Input)
					if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then 
			...
			Components.Button = function(Data)
				...
				function Button:Add(Text, Callback, Disabled)
					...
					SubItems["NewButton"]:Connect("InputBegan", function(Input)
						if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
							NewButton:Press()
						end
					end)
			...
			Components.Dropdown = function(Data)
					...
					Items["Input"]:Connect("Focused", function()
						RenderStepped = RunService.RenderStepped:Connect(function()
							for Index, Value in Dropdown.Options do 
								...
								elseif Items["Input"].Instance.Text == "" then
									Value.Button.Instance.Visible = true
								else
				...
				function Dropdown:SetOpen(Bool)
					...
					Library:Connect(NewTween.Tween.Completed, function()
						...
						Items["OptionHolder"].Instance.Parent = self.IsOpen and Library.Holder.Instance or Library.UnUsedHolder
					end)
				end
			...
			Components.Colorpicker = function(Data)
				...
				function Colorpicker:SetOpen(Bool)
					...
					Library:Connect(NewTween.Tween.Completed, function()
						...
						Items["ColorpickerWindow"].Instance.Parent = self.IsOpen and Library.Holder.Instance or Library.UnusedHolder.Instance
					end)
				end
			...
			Components.Keybind = function(Data)
				...
				Items["KeyButton"]:Connect("InputBegan", function(Input)
					...
					InputBegan = UserInputService.InputBegan:Connect(function(Input)
						if UserInputService:GetFocusedTextBox() then return end -- typing, ignore
		...
		Library.Watermark = function(self, Name)
			...
			Library:Connect(RunService.RenderStepped, function()
				...
				Items["Text"].Instance.Text = Name .. "\nFPS: "..tostring(FramesPerSecond).." ms: "..tostring(MathFloor(Stats.Network.ServerStatsItem['Data Ping']:GetValue()))
			end)
