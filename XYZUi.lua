...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "rbxassetid://15297431949"
...
Title.Text = "MEWING HUB - VERSION " .. os.date("%d/%m/2024") .. " | " .. "<font color='rgb(232, 181, 138)'>" .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .. " </font>"
Title.RichText = true;
...
Fruit.Font = Enum.Font.FredokaOne
...
StaminaText.Font = Enum.Font.FredokaOne
...
Fragment.Font = Enum.Font.FredokaOne
local Players = game:GetService("Players")
local LocalizationService = game:GetService("LocalizationService")

Fragment.Text = "Country: " .. LocalizationService:GetCountryRegionForPlayerAsync(Players.LocalPlayer)
...
spawn(function()
  while wait(0.001) do
    pcall(function()
        ...
        Beli.Text = "Health: " .. math.floor(humanoid.Health) .. "/" .. math.floor(humanoid.MaxHealth)
        StaminaText.Text = "FPS: " .. math.floor(workspace:GetRealPhysicsFPS())
        HealthText.Text = "Ping: " .. game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
    end)
  end
end)
...
spawn(function()
  ...
  while true do
    pcall(function()
      ...
      Lvl.Text = "Time:" .. os.date(" %H:%M:%S - %d/%m/2024")
    end)
    wait(0.001)
  end
end)
...
Textbtn2.Font = Enum.Font.FredokaOne
Textbtn2.Text = ""
...
Textbtn2.MouseButton1Click:Connect(function()
  ...
  loadstring(game:HttpGet("https://raw.githubusercontent.com/TranVanBao1411/SupportBuLon/retard/FlyBuLon"))()
  end)
...
Textlavel3.Font = Enum.Font.FredokaOne
Textlavel3.Text = "ESP"
...
Texbob3.Font = Enum.Font.FredokaOne
Texbob3.Text = ""
...
Texbob3.MouseButton1Click:Connect(function()
  ...
  _G.Settings = {
         ["EnableEsp"] = true, --// false Turn Off // true Turn On \\--
         ["Distance"] = 9e9
      }
        loadstring(game:HttpGet("https://raw.githubusercontent.com/buiihungg/AquaHub/main/Esp.lua"))()
  end)
...
Textlval3.ZIndex = 16
Textlval3.Font = Enum.Font.FredokaOne
...
Texbslb4.Font = Enum.Font.FredokaOne
Texbslb4.Text = ""
...
Textlval4.ZIndex = 16
Textlval4.Font = Enum.Font.FredokaOne
...
Texbslb5.Font = Enum.Font.FredokaOne
Texbslb5.Text = ""
...
Textlval5.ZIndex = 16
Textlval5.Font = Enum.Font.FredokaOne
...
Texbslb6.Font = Enum.Font.FredokaOne
Texbslb6.Text = ""
...
DropTitle.Font = Enum.Font.FredokaOne
...
LabelNameSlider.Font = Enum.Font.FredokaOne
...
CustomValue.Font = Enum.Font.FredokaOne
CustomValue.Text = "50"
