...
local IndexUIColor = {
    ...
    ["Logo Image"] = "rbxassetid://17664629557",
...
function SaveCustomUISettings()
    ...
    writefile("ELGATO HUB/" .. SaveCustomFileName, HttpService:JSONEncode(CorrectTable(SettingsRac)))
end
...
function ReadCustomUISetting() 
    local s,e = pcall(function() 
        ...
        return HttpService:JSONDecode(readfile("ELGATO HUB/" .. SaveCustomFileName))
    end)
    if s then return e 
    else
...
Library_Function.Gui.Name = 'ELGATO HUB GUI'
...
Library_Function.NotiGui.Name = 'ELGATO HUB Notification'
...
function Library.CreateMain(Setting)
    ...
    getgenv().MainDesc = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name.. "/ https://discord.gg/UrkE64Mfb7 / by .tranvanbaodeptrai"
