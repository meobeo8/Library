...
for _, v in ipairs(game:GetService("CoreGui"):GetChildren()) do
    if v.Name == "elgato_status" or v.Name == "redz Library V5" or v.Name == "ELGATO HUB ON/OFF" or v.Name == "ELGATO TIME" or v.Name == "elgato_blackscreen" or v.Name == "ToggleUIButton" then
        v:Destroy()
    end
end
