...
local Values =  = "rbxassetid://83514188134754" -- Icon of the button for toggle fluent ui
----------------------------
...
local MinimizeButton = New("TextButton", {
	...
	New("ImageLabel", {
		Image = Values =  or "rbxassetid://10734897102",
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = 1,
	}, {
...
Minimizer = New("Frame", {
	...
	New("Frame", {
		BackgroundColor3 = Color3.fromRGB(0, 0, 0),
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = isMobile and 0.5 or 0.25,
		BorderSizePixel = 0
	}, {
		New("UICorner", {
